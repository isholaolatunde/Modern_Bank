...
const Hero = () => (
    <section id='home' className={`flex md:flex-row flex-col
     ${styles.paddingY}`}>
      ...
      <h1 className="font-popping font-semibold ss:text-[70px]
      text-[68px] text-white ss:leading-[100px] 
      leading-[75px] w-full">
         Payment Method.
      </h1>
      <p className={`${styles.paragraph} max-w-[483px] mt-5`}>Our team of experts uses a methodology to 
